const questions = [
  {
    question:
      "Прочитайте речення (цифра позначає наступне слово).<br><i>(1)Чотирнадцятого (2)листопада трапився курйозний (3)випадок: (4)мережа магазинів (5)«Решето» продала покупцям цілий (6)центнер (7)курятини всього за (8)сімдесят гривень, про що свідчив (9)виразний (10)цінник.</i><br><b>НЕПРАВИЛЬНО</b> підкреслено букви на позначення наголошених голосних у всіх словах, позначених цифрами",
    answers: [
